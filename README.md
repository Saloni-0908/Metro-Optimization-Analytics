# Delhi Metro Operations Optimization Analytics
...
```bash
# Clone the repo
git clone [https://github.com/Saloni-0908/Metro-Optimization-Analytics.git]
cd Metro-Optimization-Analytics
...
> *Project conducted as part of Product Club IITK Summer Project Program, 2025*
